...
path = 'E:\\darshan\\engineering\\major project\\Blockchain-Based-E-Voting-System-using-Facial-Recognition-main\\Blockchain based E-voting system using Facial Recgonition\\server\\Faces'
    ...
    def findEncodings(images):
        ...
        for img in images:
            try:
                ...
                temp_path = '"E:\darshan\engineering\major project\Blockchain-Based-E-Voting-System-using-Facial-Recognition-main\Blockchain based E-voting system using Facial Recgonition\server\Faces\temp.jpg"'
